...
backbone_presets_no_weights = {
    "resnet18_vd": {
        "metadata": {
            "description": ("ResNet_vd model with 18 layers."),
            "params": 11205472,
    ...
    "resnet34_vd": {
        "metadata": {
            "description": ("ResNet_vd model with 34 layers."),
            "params": 21321056,
            "official_name": "ResNetVd",
            "path": "resnet_vd",
        },
    ...
    "resnet50_vd": {
        "metadata": {
            "description": ("ResNet_vd model with 50 layers."),
            "params": 23580512,
            "official_name": "ResNetVd",
            "path": "resnet_vd",
        },
    ...
    "resnet101_vd": {
        "metadata": {
            "description": ("ResNet_vd model with 101 layers."),
            "params": 42624864,
            "official_name": "ResNetVd",
            "path": "resnet_vd",
        },
    ...
    "resnet152_vd": {
        "metadata": {
            "description": ("ResNet_vd model with 152 layers."),
            "params": 58314592,
            "official_name": "ResNetVd",
            "path": "resnet_vd",
        },
